...
from world_studio import help_cli
from world_studio.format import plain
from world_studio.help_cli import (
    help_text_for_query,
    main,
    print_help_query,
    run_help_tui,
...
from world_studio.help_topics import render_help_topic
from world_studio.help_ui import render_numbered_index
...
class HelpCliMainTests(unittest.TestCase):
    ...
    def test_entry_point_and_textual_structure(self) -> None:
        ...
        self.assertIn("world-studio-help", text)
        self.assertIn("world_studio.help_cli:main", text)
...
class HelpCliSubprocessTests(unittest.TestCase):
    """Real ``python -m world_studio.help_cli --print`` launch path."""

    def _run(self, *args: str) -> subprocess.CompletedProcess[str]:
        return subprocess.run(
            [sys.executable, "-m", "world_studio.help_cli", *args],
            capture_output=True,
            text=True,
