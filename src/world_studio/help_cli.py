...
Examples::
    ...
    world-studio-help              # Textual display (TTY)
    world-studio-help look         # Textual opened on topic
    world-studio-help --print look # one-shot plain print (scripts)
    world-studio-help -i           # line-mode interactive
...
def main(argv: list[str] | None = None) -> int:
    """Entry for console script and ``python -m world_studio.help_cli``."""
