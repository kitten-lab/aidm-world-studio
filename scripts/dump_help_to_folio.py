"""Dump world-studio help topics into a Kitten-Lab folio + optional .ven pack.
...
from world_studio.db import connect, get_meta  # noqa: E402
from world_studio.format import plain  # noqa: E402
from world_studio.help_topics import (  # noqa: E402
...
from world_studio.world import World  # noqa: E402
...
def put_in_world(world_path: Path, pages: list[tuple[str, str]]) -> tuple[str, str]:
    ...
    if existing is not None:
        ...
        ven_id = w.create_ven(
            ...
            "folio",
            (
                "Full command help dump from world-studio (help_topics). "
...
def export_ven_pack(world: World, inst_id: str, *, origin: str) -> Path:
    from world_studio.ven_pack import export_instance, ven_collector_dir
